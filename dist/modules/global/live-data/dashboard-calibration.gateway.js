...
let DashboardCalibrationGateway = class DashboardCalibrationGateway {
    ...
    handleDisconnect(client) {
        if (this.sessionsConnected.has(client.id) == false) {
            ...
            if (sesionData.type == 1) {
                ...
                console.log(...oo_oo(`48465913_62_16_62_78_4`, "web de " + sesionData.userName + " desconectada"));
            }
            else if (sesionData.type == 0) {
                this.serials = [];
                this.maxMeasures = 0;
                this.server.emit('calibrator-client-disconnected');
                console.log(...oo_oo(`48465913_67_16_67_52_4`, "terminal desconectada"));
            }
    ...
    connectCalibratorClient(client, dataPorts) {
        if (this.sessionsConnected.has(client.id) == false) {
            ...
            console.log(...oo_oo(`48465913_86_12_86_47_4`, "Calibrador conectado"));
        }
    ...
    getProgress(client, measureOfM) {
        console.log(...oo_oo(`48465913_105_8_105_31_4`, measureOfM));
    ...
    checkTerminalConected() {
        ...
        if (terminalConected) {
            console.log(...oo_oo(`48465913_174_12_174_45_4`, "terminal conectada"));
            this.server.emit('client-calibrator-connected');
            if (this.checkWebClientConected()) {
                console.log(...oo_oo(`48465913_178_16_178_48_4`, "mandando seriales"));
            ...
            console.log(...oo_oo(`48465913_185_12_185_51_4`, "sin calibrador conectado"));
        }
    }
    checkWebClientConected() {
        ...
        if (webConected) {
            console.log(...oo_oo(`48465913_199_12_199_40_4`, "web conectada"));
            this.server.emit('web-client-connected');
        }
        else {
            console.log(...oo_oo(`48465913_202_12_202_44_4`, "sin web conectada"));
        }
        return webConected;
    }
};
