    ...
    async login(body) {
        try {
            ...
            if (loginData.serialNumber == null ||
                ...
                if (loginData.serialNumber == null ||
                    loginData.serialNumber == undefined) {
                    console.log(...oo_oo(`3248732785_100_10_100_57_4`, 'serialNumber es null o undefined'));
                }
                if (loginData.imei == null || loginData.imei == undefined) {
                    console.log(...oo_oo(`3248732785_104_10_104_49_4`, 'imei es null o undefined'));
                }
                if (loginData.serialNumber && loginData.serialNumber.length != 8) {
                    console.log(...oo_oo(`3248732785_108_10_108_45_4`, loginData.serialNumber));
                    console.log(...oo_oo(`3248732785_109_10_109_52_4`, loginData.serialNumber.length));
                    console.log(...oo_oo(`3248732785_110_10_110_60_4`, 'La longitud de serialNumber no es 8'));
                }
                if (loginData.imei && loginData.imei.length != 15) {
                    console.log(...oo_oo(`3248732785_114_10_114_37_4`, loginData.imei));
                    console.log(...oo_oo(`3248732785_115_10_115_44_4`, loginData.imei.length));
                    console.log(...oo_oo(`3248732785_116_10_116_53_4`, 'La longitud de imei no es 15'));
                }
...
`);
            ...
            if (haveInterval) {
                ...
                console.log(...oo_oo(`3248732785_494_8_494_47_4`, dataloggerRegisters.length));
                ...
                for (let index = 0; index < dataloggerRegisters.length; index++) {
                    ...
                    console.log(...oo_oo(`3248732785_525_10_525_47_4`, reverseString(binAlerts)));
                }
                alerts.pop();
    ...
    debugAlerts(alerts) {
        ...
        console.log(...oo_oo(`3248732785_1601_4_1601_66_4`, `Alert value: ${alerts}, Binary: ${binaryString}`));
        console.log(...oo_oo(`3248732785_1602_4_1602_55_4`, `Drip Alert: ${(alerts >>> 0) & 0x01}`));
        console.log(...oo_oo(`3248732785_1603_4_1603_56_4`, `Empty Alert: ${(alerts >>> 1) & 0x01}`));
        console.log(...oo_oo(`3248732785_1604_4_1604_64_4`, `Inverted Flow Alert: ${(alerts >>> 2) & 0x01}`));
        console.log(...oo_oo(`3248732785_1605_4_1605_55_4`, `Leak Alert: ${(alerts >>> 3) & 0x01}`));
        console.log(...oo_oo(`3248732785_1606_4_1606_57_4`, `Bubble Alert: ${(alerts >>> 4) & 0x01}`));
        console.log(...oo_oo(`3248732785_1607_4_1607_63_4`, `Manipulation Alert: ${(alerts >>> 5) & 0x01}`));
    }
};
